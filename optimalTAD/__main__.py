...
The basic optimalTAD commands are:
    ...
    def call_argparse(self):
        ...
        parser.add_argument('--save_normalized_chip', action = argparse.BooleanOptionalAction, help = "Save normalized ChIP-seq (for mammals only!)")
        ...
        parser.add_argument('--save_insulation_score', action = argparse.BooleanOptionalAction, help = "Save insulation score results (for mammals only!)")
        ...
        parser.set_defaults(save_normalized_chip = eval(self.cfg['run']['save_normalized_chip']))
